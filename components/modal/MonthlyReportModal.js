...
//   const { user, role } = useAuth();
  ...
  const theme = {
    text: {
      ...
      secondary: isDark ? '#d2d2d2' : '#1e1e1e',
      tertiary: isDark ? '#828282' : '#828282',
    },
  ...
  const handleGuestCountChange = (field, type) => (value) => {
    ...
    setGuestCounts((prev) => ({ ...prev, [field]: numValue }));
              ...
              {isFetchingReport ? (
                ...
                <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={{ flex: 1 }}>
                      <MainTextInput
                        ...
                        keyboardType="numeric"
                        variant="outlined"
                        disabled={fieldModes.filipino === 'total' || isViewMode}
                  ...
                  <MainTextInput
                    ...
                    keyboardType="numeric"
                    variant="outlined"
                    disabled={fieldModes.filipino === 'disaggregated' || isViewMode}
                    helperText={
                  ...
                  <View style={styles.row}>
                    <View style={{ flex: 1 }}>
                      <MainTextInput
                        ...
                        keyboardType="numeric"
                        variant="outlined"
                        disabled={fieldModes.foreign === 'total' || isViewMode}
                        style={styles.noBottomMargin}
                      />
                    </View>
                    <View style={{ flex: 1 }}>
                  ...
                  <MainTextInput
                    ...
                    keyboardType="numeric"
                    variant="outlined"
                    disabled={fieldModes.foreign === 'disaggregated' || isViewMode}
                    helperText={
                  ...
                  <View style={styles.row}>
                    <View style={{ flex: 1 }}>
                      <MainTextInput
                        ...
                        keyboardType="numeric"
                        variant="outlined"
                        disabled={fieldModes.ofw === 'total' || isViewMode}
                        style={styles.noBottomMargin}
                      />
                    </View>
                  </View>
                  <MainTextInput
                    ...
                    keyboardType="numeric"
                    variant="outlined"
                    disabled={fieldModes.ofw === 'disaggregated' || isViewMode}
                    helperText={
                  ...
                  {nationalities.map((nation) => {
                    ...
                    return (
                      <View key={nation.nationality} style={styles.nationalitySection}>
                        ...
                        <View style={styles.row}>
                          <View style={{ flex: 1 }}>
                            <MainTextInput
                              ...
                              keyboardType="numeric"
                              variant="outlined"
                              disabled={fieldMode === 'total' || isViewMode}
                              style={styles.noBottomMargin}
                            />
                          </View>
                          <View style={{ flex: 1 }}>
                        ...
                        <MainTextInput
                          ...
                          keyboardType="numeric"
                          variant="outlined"
                          disabled={fieldMode === 'disaggregated' || isViewMode}
                          helperText={
                  ...
                  {!isViewMode && (
                    <MainSelectInput
                      ...
                      onChange={(value) => handleAddNationality(value)}
